{
    "audience-segmentation-15": {
        "activation_event_name": "mas_audience_segmentation_15",
    ...
    "cltv-180-90": {
        "activation_event_name": "mas_cltv_180_90",
        "source_query_template": "${cltv_query_template_gcs_path}",
        "measurement_protocol_payload_template": "${measurement_protocol_payload_template_gcs_path}"
    },
    "cltv-180-30": {
        "activation_event_name": "mas_cltv_180_30",
        "source_query_template": "${cltv_query_template_gcs_path}",
        "measurement_protocol_payload_template": "${measurement_protocol_payload_template_gcs_path}"
    },
    "purchase-propensity-30-15": {
        "activation_event_name": "mas_purchase_propensity_30_15",
        "source_query_template": "${purchase_propensity_query_template_gcs_path}",
        "measurement_protocol_payload_template": "${measurement_protocol_payload_template_gcs_path}"
    },
    "purchase-propensity-15-15": {
        "activation_event_name": "mas_purchase_propensity_15_15",
        "source_query_template": "${purchase_propensity_query_template_gcs_path}",
        "measurement_protocol_payload_template": "${measurement_protocol_payload_template_gcs_path}"
    },
    "purchase-propensity-15-7": {
        "activation_event_name": "mas_purchase_propensity_15_7",
        "source_query_template": "${purchase_propensity_query_template_gcs_path}",
        "measurement_protocol_payload_template": "${measurement_protocol_payload_template_gcs_path}"
    }
}