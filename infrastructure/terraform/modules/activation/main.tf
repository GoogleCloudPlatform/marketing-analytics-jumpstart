...
data "external" "ga4_measurement_properties" {
  ...
  count       = (var.measurement_id == null || var.measurement_secret == null) ? 1 : 0
}
  ...
  secrets = [
    {
      ...
      secret_data           = (var.measurement_id == null || var.measurement_secret == null) ? data.external.ga4_measurement_properties.result["measurement_id"] : var.measurement_id
      automatic_replication = true
    },
    {
      name                  = "ga4-measurement-secret"
      secret_data           = (var.measurement_id == null || var.measurement_secret == null) ? data.external.ga4_measurement_properties.result["measurement_secret"] : var.measurement_secret
      automatic_replication = true
    },
  ]
